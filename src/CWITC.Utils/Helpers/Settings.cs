...
namespace CWITC.Clients.Portable
{
    ...
    public class Settings : INotifyPropertyChanged
    {
        ...
        {
            get { return AppSettings.GetValueOrDefault(TwitterApiKeyKey, TwitterApiKeyDefault); }
            set
            {
        ...
        {
            get { return AppSettings.GetValueOrDefault(TwitterApiSecretKey, TwitterApiSecretDefault); }
            set
            {
